...
public class AssociativeArrayTest {
    ...
    public void setUp() {
        ...
        user1 = new User("Tom J", 0, new GregorianCalendar(1995, 4, 20));
        user2 = new User("Kate H", 1, new GregorianCalendar(1990, 7, 23));
        user3 = new User("Anton D", 4, new GregorianCalendar(1967, 11, 13));
        user4 = new User("Roman M", 1, new GregorianCalendar(1997, 8, 6));
        user5 = new User("Petr A", 1, new GregorianCalendar(1987, 5, 17));
        user6 = new User("Artur N", 2, new GregorianCalendar(1980, 10, 27));
